...
% ---- Title block -----------------------------------------------
\begin{center}
    {\large The University of Melbourne}\\[0.4em]
    {\large COMP30024 -- Artificial Intelligence}\\[0.2em]
    {\large Project Part B: Game Playing Agent}\\[1em]
...
\bibitem{chatgpt}
OpenAI. (2026).
\textit{ChatGPT} [Large language model].

...
metadata = {
    ...
    "team_name": f"Water_bottle", 

    # Fill in the student IDs and emails of both team members here. There must
    # be exactly two members in the list. 
    "team_members": [
        {
            "name": "Phuong Trang Tran",
            "student_id": "1409465",
            "email": "phuongtrang.tran@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Ha Linh Nguyen",
            "student_id": "1482069",
            "email": "halinh.nguyen2@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
